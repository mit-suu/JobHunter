...
function CategoryItem({ icon, label, jobs }) {
  ...
  return (
    <Link to={`/category/${label}`}>
      <div className="group flex cursor-pointer flex-col justify-center gap-y-[24px] rounded-sm border bg-white p-[24px] font-poppins text-[#4640DE] transition hover:bg-[#4640DE]">
