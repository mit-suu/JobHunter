...
function Header() {
  ...
  return (
    <header className="fixed left-0 top-0 z-50 w-full bg-white shadow-sm dark:bg-gray-900">
          ...
          <nav className="relative flex space-x-8 text-sm font-medium">
            ...
            <NavLink
              ...
              className={({ isActive }) =>
                isActive
                  ? "text-[#4640DE]"
                  : "text-gray-600 transition-colors hover:text-[#4640DE] dark:text-gray-300"
              }
            >
              Find Jobs
            </NavLink>
        ...
        <div className="flex items-center space-x-4 p-5 text-gray-600">
          <div>
            <button
              ...
              className="rounded-full p-2 transition hover:rounded-full hover:bg-gray-100"
              title="Settings"
            >
              <svg
