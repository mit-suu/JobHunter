...
<div className="absolute top-10 left-[70px] z-20">
  ...
  <div className="relative z-10 text-center p-12 bg-white/60 rounded-xl shadow-md backdrop-blur">
    <h2 className="text-4xl font-bold text-gray-800 mb-6">Join JobHunter!</h2>
    <p className="text-lg text-gray-700">Over 100K+ people got hired</p>
  </div>
</div>
        ...
        <div className="w-1/2 flex flex-col justify-center px-20">
          <h2 className="text-3xl font-bold font-poppins text-gray-800 mb-6">Create your account</h2>
